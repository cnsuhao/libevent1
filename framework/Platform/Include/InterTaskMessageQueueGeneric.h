#ifndef INTERTASKMESSAGEQUEUEGENERIC_H
#define INTERTASKMESSAGEQUEUEGENERIC_H
...
{
    class InterTaskMessage:public RefCountedObject
    {
    public:
        ...
        typedef AutoPtr<InterTaskMessage> AutoInterTaskMsgPtr;
    ...
    public:
        ...
        void enqueueNotification(InterTaskMessage::AutoInterTaskMsgPtr pNotification);
        ...
        void enqueueUrgentNotification(InterTaskMessage::AutoInterTaskMsgPtr pNotification);
        /// Enqueues the given notification by adding it to
    ...
    protected:
        InterTaskMessage::AutoInterTaskMsgPtr dequeueOne();

    private:
        typedef std::deque<InterTaskMessage::AutoInterTaskMsgPtr> NfQueue;
        struct WaitInfo
        {
